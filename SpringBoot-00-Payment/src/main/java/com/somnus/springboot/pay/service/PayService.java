...
public interface PayService extends PaymentService {
     ...
     * @return
     */
    public void handleCallback(RequestParameter<?, String> callbackParameter, PaymentResult...paymentResults);
     ...
     * @return
     */
    public Message getOrderDetails(String orderId,Integer source);
     ...
     * @return
     */
    public Message queryPaymentOrder(Map<String,String> params,PayChannel payType);
     ...
     * @return
     */
    public Message updateStatusManual(Map<String,String> params);
     ...
     * @return
     */
    public PaymentOrder getPaymentOrder(String key);
     ...
     */
    public boolean mergePaymentOrder(PaymentOrder paymentOrder);
